								...
								<table id="simple-table" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<th class="col-xs-3">公司</th>
											<th class="col-xs-7">分类  &ensp;(点击查看分类产品)</th>
											<th class="col-xs-1">
												操作
											</th>
										</tr>
									...
									<tbody>
										<?php if(is_array($company)): foreach($company as $key=>$val): ?><tr>
												...
												<td><a href="#" title="sort"><?php echo ($val["sort"]); ?></a></td>
												<td>
													<div class="hidden-sm hidden-xs action-buttons">
															...
															<a class="red" href="<?php echo U('del');?>?id=<?php echo ($val["id"]); ?>}">
