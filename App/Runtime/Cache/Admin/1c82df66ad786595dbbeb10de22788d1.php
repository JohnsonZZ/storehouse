...
<html lang="en">
				...
				<ul class="nav nav-list">
					...
					<li id="allCompany">
						...
						<ul class="submenu">
							...
							<li id="addSort">
								<a href="<?php echo U('Company/sort');?>">
									<i class="menu-icon fa fa-caret-right"></i>
									添加分类
								</a>
								<b class="arrow"></b>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" action="<?php echo U('Company/update');?>" id="formCompany" role="form" method="post">
									<!-- #section:elements.form -->
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="company"> 公司名 </label>
										<div class="col-sm-9">
											<input type="text" id="company" placeholder="company" name="company" class="col-xs-10 col-sm-5">
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info addButton" type="button" id="addSubmit"> 
	...
	<div class="footer-inner">
		...
		<script type="text/javascript">
			$('#allCompany').addClass("active").siblings().removeClass("active");
